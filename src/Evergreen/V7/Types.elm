...
type alias StartModel =
    ...
    , pressedSubmit : Bool
    , loginFailed : Bool
    , cache : Maybe Evergreen.V7.Cache.Cache
    , branch : Maybe Evergreen.V7.Github.Branch
    }
...
type alias ParsingModel =
    ...
    , cache : Maybe Evergreen.V7.Cache.Cache
    , branch : Evergreen.V7.Github.Branch
    }
...
type alias EditorModel =
    ...
    , translations : List Evergreen.V7.TranslationParser.TranslationDeclaration
    , oauthToken : Evergreen.V7.Github.OAuthToken
...
type State
    = Start StartModel
    | Authenticate (Maybe Evergreen.V7.Cache.Cache) (Maybe Evergreen.V7.Github.Branch)
...
type ToBackend
    ...
    | GetZipRequest Evergreen.V7.Github.OAuthToken (Maybe Evergreen.V7.Github.Branch)


type BackendMsg
    = GotAccessToken Lamdera.ClientId (Result Http.Error Evergreen.V7.Github.AccessTokenResponse)
    | LoadedZipBackend Lamdera.ClientId (Result Http.Error ( Evergreen.V7.Github.Branch, Bytes.Bytes ))


type ToFrontend
    = AuthenticateResponse (Result Http.Error Evergreen.V7.Github.OAuthToken)
    | GetZipResponse (Result Http.Error ( Evergreen.V7.Github.Branch, Bytes.Bytes ))
