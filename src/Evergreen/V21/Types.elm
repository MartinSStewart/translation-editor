...
import Bytes
import Evergreen.V21.Github
import Evergreen.V21.TranslationParser
import Http
import Lamdera
...
type alias LoadingModel =
    { oauthToken : Evergreen.V21.Github.OAuthToken
...
type alias ParsingModel =
    ...
    , parsedFiles :
        List
            { path : String
            , result : List Evergreen.V21.TranslationParser.TranslationDeclaration
            , original : String
            }
    , oauthToken : Evergreen.V21.Github.OAuthToken
...
type alias EditorModel =
    ...
    , translations : List Evergreen.V21.TranslationParser.TranslationDeclaration
    , oauthToken : Evergreen.V21.Github.OAuthToken
...
type FrontendMsg
    ...
    | UrlChanged Url.Url
    | GotRepository Evergreen.V21.Github.OAuthToken (Result Http.Error (List ( String, String )))
    ...
    | ParsedFile
        { path : String
        , result : Result () (List Evergreen.V21.TranslationParser.TranslationDeclaration)
        , original : String
        }
...
type ToBackend
    = AuthenticateRequest Evergreen.V21.Github.OAuthCode
    | GetZipRequest Evergreen.V21.Github.OAuthToken


type BackendMsg
    = GotAccessToken Lamdera.ClientId (Result Http.Error Evergreen.V21.Github.AccessTokenResponse)
...
type ToFrontend
    = AuthenticateResponse (Result Http.Error Evergreen.V21.Github.OAuthToken)
