...
type alias StartModel =
    ...
    , pressedSubmit : Bool
    , loginFailed : Bool
    , cache : Maybe Evergreen.V10.Cache.Cache
    , branch : Maybe Evergreen.V10.Github.Branch
    }
...
type alias ParsingModel =
    ...
    , cache : Maybe Evergreen.V10.Cache.Cache
    , branch : Evergreen.V10.Github.Branch
    }
...
type State
    = Start StartModel
    | Authenticate (Maybe Evergreen.V10.Cache.Cache) (Maybe Evergreen.V10.Github.Branch)
...
type ToBackend
    ...
    | GetZipRequest Evergreen.V10.Github.OAuthToken (Maybe Evergreen.V10.Github.Branch)


type BackendMsg
    = GotAccessToken Lamdera.ClientId (Result Http.Error Evergreen.V10.Github.AccessTokenResponse)
    | LoadedZipBackend Lamdera.ClientId (Result Http.Error ( Evergreen.V10.Github.Branch, Bytes.Bytes ))


type ToFrontend
    = AuthenticateResponse (Result Http.Error Evergreen.V10.Github.OAuthToken)
    | GetZipResponse (Result Http.Error ( Evergreen.V10.Github.Branch, Bytes.Bytes ))
