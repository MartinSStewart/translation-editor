...
import Bytes
import Evergreen.V22.Github
import Evergreen.V22.TranslationParser
import Http
import Lamdera
...
type alias LoadingModel =
    { oauthToken : Evergreen.V22.Github.OAuthToken
...
type alias ParsingModel =
    ...
    , parsedFiles :
        List
            { path : String
            , result : List Evergreen.V22.TranslationParser.TranslationDeclaration
            , original : String
            }
    , oauthToken : Evergreen.V22.Github.OAuthToken
...
type alias EditorModel =
    ...
    , translations : List Evergreen.V22.TranslationParser.TranslationDeclaration
    , oauthToken : Evergreen.V22.Github.OAuthToken
...
type FrontendMsg
    ...
    | UrlChanged Url.Url
    | GotRepository Evergreen.V22.Github.OAuthToken (Result Http.Error (List ( String, String )))
    ...
    | ParsedFile
        { path : String
        , result : Result () (List Evergreen.V22.TranslationParser.TranslationDeclaration)
        , original : String
        }
...
type ToBackend
    = AuthenticateRequest Evergreen.V22.Github.OAuthCode
    | GetZipRequest Evergreen.V22.Github.OAuthToken


type BackendMsg
    = GotAccessToken Lamdera.ClientId (Result Http.Error Evergreen.V22.Github.AccessTokenResponse)
...
type ToFrontend
    = AuthenticateResponse (Result Http.Error Evergreen.V22.Github.OAuthToken)
