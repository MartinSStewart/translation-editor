...
import Bytes
import Evergreen.V5.Cache
import Evergreen.V5.Github
...
type alias StartModel =
    ...
    , pressedSubmit : Bool
    , loginFailed : Bool
    , cache : Maybe Evergreen.V5.Cache.Cache
    , branch : Maybe Evergreen.V5.Github.Branch
    }


type alias LoadingModel =
    { oauthToken : Evergreen.V5.Github.OAuthToken
...
type alias ParsingModel =
    ...
    , parsedFiles :
        List
            { path : String
            , result : List Evergreen.V5.TranslationParser.TranslationDeclaration
            , original : String
            }
    , oauthToken : Evergreen.V5.Github.OAuthToken
    , loadedChanges : AssocList.Dict TranslationId String
    , cache : Maybe Evergreen.V5.Cache.Cache
    , branch : Evergreen.V5.Github.Branch
    }
...
type alias EditorModel =
    ...
    , translations : List Evergreen.V5.TranslationParser.TranslationDeclaration
    , oauthToken : Evergreen.V5.Github.OAuthToken
...
type State
    = Start StartModel
    | Authenticate (Maybe Evergreen.V5.Cache.Cache) (Maybe Evergreen.V5.Github.Branch)
...
type FrontendMsg
    ...
    | ParsedFile
        { path : String
        , result : Result () (List Evergreen.V5.TranslationParser.TranslationDeclaration)
        , original : String
        }
...
type ToBackend
    = AuthenticateRequest Evergreen.V5.Github.OAuthCode
    | GetZipRequest Evergreen.V5.Github.OAuthToken (Maybe Evergreen.V5.Github.Branch)


type BackendMsg
    = GotAccessToken Lamdera.ClientId (Result Http.Error Evergreen.V5.Github.AccessTokenResponse)
    | LoadedZipBackend Lamdera.ClientId (Result Http.Error ( Evergreen.V5.Github.Branch, Bytes.Bytes ))


type ToFrontend
    = AuthenticateResponse (Result Http.Error Evergreen.V5.Github.OAuthToken)
    | GetZipResponse (Result Http.Error ( Evergreen.V5.Github.Branch, Bytes.Bytes ))
